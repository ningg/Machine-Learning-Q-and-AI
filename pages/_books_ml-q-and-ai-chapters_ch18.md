...
itâ€™s also possible to fine-tune all or just a small number of
...
Letâ€™sstartwiththeconventionalmethodsforutilizingpretrainedtransformers:
...
â€œIn-Context Learning, Indexing, and Prompt Tuningâ€? on pageÂ .)
...
high-quality, in- Â formative features from the input data. These
feature embeddings often capture complex relationships and patterns,
making it easy for aÂ linearÂ classifier to effectively separate the
...
most efficient method since it doesnâ€™t require updating the
transformer model at all. Finally, the embeddings can be precomputed for
a given training dataset (since they donâ€™t change) when training a
classifier for multiple training epochs.

FigureÂ [1.1](#fig:ch18-fig01){reference="fig:ch18-fig01"
...
updating only the output layers, a method weâ€™ll refer to as
*fine-tuning I*, and updating all layers, which weâ€™ll call
*fine-tuning II*.
...
FigureÂ [\[fig:ch18-fig02\]](#fig:ch18-fig02){reference="fig:ch18-fig02"
...
FigureÂ [1.2](#fig:ch18-fig03){reference="fig:ch18-fig03"
reference-type="ref"}.

![Prompting an LLM for in-context
learning](../images/ch18-fig03.png){#fig:ch18-fig03 style="width:98.0%"}

As FigureÂ [1.2](#fig:ch18-fig03){reference="fig:ch18-fig03"
...
approach takes advantage of the modelâ€™s ability to learn from vast
...
- â€œTranslate the German sentence â€˜{german_sentence}â€™ into English:
  {english_translation}â€?

- ------------------------------------ -----------------------------------
    â€œGerman: â€˜{german_sentence}â€™   English: {english_translation}â€?
    ------------------------------------ -----------------------------------

- â€œFrom German to English: â€˜{german_sentence}â€™ -\>
  {english_translation}â€?
...
fine-tuning, as it does not update the modelâ€™s parameters for a
...
FigureÂ [1.3](#fig:ch18-fig04){reference="fig:ch18-fig04"
reference-type="ref"}.
...
websites. In FigureÂ [1.3](#fig:ch18-fig04){reference="fig:ch18-fig04"
...
FigureÂ [1.4](#fig:ch18-fig05){reference="fig:ch18-fig05"
reference-type="ref"}.
...
on a target data- Â set using gradient descent. In Python-like
...
Letâ€™s break
ListingÂ [\[prefixTuning\]](#prefixTuning){reference="prefixTuning"
...
FigureÂ [1.5](#fig:ch18-fig06){reference="fig:ch18-fig06"
...
FigureÂ [1.6](#fig:ch18-fig07){reference="fig:ch18-fig07"
reference-type="ref"}.
...
In
ListingÂ [\[matrixMultiplication\]](#matrixMultiplication){reference="matrixMultiplication"
...
pretrained modelâ€™s knowledge and the new task-specific adaptation.
...
feedback (RLHF)*, which can be used to further improve the modelâ€™s
...
The three conventional methodsâ€"feature-based approach, fine-tuningÂ I,
